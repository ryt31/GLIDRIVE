...
namespace Valve.VR.InteractionSystem
{
	...
	public class ControllerButtonHints : MonoBehaviour
	{
		...
		protected class ActionHintInfo
		{
		...
		protected Dictionary<ISteamVR_Action_In_Source, ActionHintInfo> actionHintInfos;
		protected Transform textHintParent;

		private int colorID;

		public bool initialized { get; private set; }
		protected Vector3 centerPosition = Vector3.zero;
		...
		//-------------------------------------------------
		protected void HintDebugLog( string msg )
		{
			if ( debugHints )
			{
        ...
        protected Dictionary<string, Transform> componentTransformMap = new Dictionary<string, Transform>();
		...
		//-------------------------------------------------
		protected virtual void CreateAndAddButtonInfo(ISteamVR_Action_In action, SteamVR_Input_Sources inputSource)
		{
            /*
		...
		//-------------------------------------------------
		protected virtual void UpdateTextHint( ActionHintInfo hintInfo )
		{
            /*
