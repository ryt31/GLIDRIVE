...
public class NoButton : BaseButtonTransitioner
{
    private Image image;
    private Color initColor;
    private MenuController menuController;
    private NoAudio audio;
    private bool isTransparent = true;
    private const float FADE_OUT_TIME = 1.0f;
    private const float FADE_IN_TIME = 1.0f;
    
    // TODO 良くない...
    [SerializeField] private YesButton yesButton;
    [SerializeField] private QuitThisGameImage quitImage;
    [SerializeField] private List<BackWindowSmallImage> backWindows;
